  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-main">
      ...
      <header className="text-white py-5 px-4 md:px-6 lg:px-8 flex justify-between items-center bg-black bg-opacity-50">
        <h1 className="text-2xl font-bold">Level Up Your Fitness</h1>
      ...
      <div className="flex-grow flex flex-col items-center justify-center space-y-4">
          <h2 className="text-3xl md:text-4xl font-bold text-white typing-animation">
            Level Up Your Fitness: Revolutionize Your Healthcare Experience
          </h2> 
          <p className="text-sm md:text-base text-gray-400 text-center max-w-3xl">
          Introducing Level Up Your Fitness: Revolutionize Your Health Journey with Personalized Workout and Diet Plans. Dive into a world of customized fitness strategies and dynamic progress tracking. Elevate your wellness with precision, privacy, and motivation—where your goals meet our expertise.
          </p>
          <div className="mt-4">
            {" "}
      ...
      <footer className="text-gray-400 py-5 text-center bg-black bg-opacity-50">
        <span>
          ©️ {new Date().getFullYear()} Level Up Your Fitness. All Rights Reserved.
        </span>
      </footer>
    </div>
  );
